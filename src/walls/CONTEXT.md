...
| [`wall-overlay-ops.ts`](wall-overlay-ops.ts) | [`wall-overlay-ops.d.ts`](wall-overlay-ops.d.ts) | `wallColor`, `drawWallDisplay`, `drawWallDrag`, `drawWallSelect`, `WALL_COLORS` | Per-wall IsoRenderer drawing + endpoint drag logic. |
