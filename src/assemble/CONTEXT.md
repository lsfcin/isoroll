...
| [`layout-parse.ts`](layout-parse.ts) | [`layout-parse.d.ts`](layout-parse.d.ts) | `validate`, `parseText`, `load`, `kind`, `rotateCw` | T3 — TS twin of layout_parse.py (DSL subset): parse, validate, rotate. |
