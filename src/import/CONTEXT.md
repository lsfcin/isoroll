...
| [`import-tiles.ts`](import-tiles.ts) | [`import-tiles.d.ts`](import-tiles.d.ts) | `manifestTileToData`, `cellCenter`, `spriteFlag` | Pure manifest-tile → Foundry Tile creation-data mapping (C1, T2). v14 center convention. |
