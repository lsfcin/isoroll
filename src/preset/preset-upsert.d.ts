export declare const tileUpsertTimers: Map<string, NodeJS.Timeout>;
export declare const tokenUpsertTimers: Map<string, NodeJS.Timeout>;
export declare const bgUpsertTimers: Map<string, NodeJS.Timeout>;
