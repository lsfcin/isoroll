...
| [`mesh-accessor.ts`](mesh-accessor.ts) | [`mesh-accessor.d.ts`](mesh-accessor.d.ts) | `meshQuad`, `meshBounds`, `MeshAccessor` | Typed, null-safe reader of tile/token mesh geometry. |
