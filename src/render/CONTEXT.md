...
| [`iso-tile-rects.ts`](iso-tile-rects.ts) | [`iso-tile-rects.d.ts`](iso-tile-rects.d.ts) | `dumpTileRects`, `stageRect`, `assetOf`, `flagNumber`, `identityOf` | dumpTileRects — where every tile's sprite ACTUALLY landed, as numbers. |
