...
| [`iso-sprite-layer.ts`](iso-sprite-layer.ts) | — | `cloneSprite`, `syncSprite`, `IsoSpriteLayer`, `getMesh`, `docAlpha` | Iso Sprite Layer — PIXI.Container on canvas.stage outside VisibilityFilter scope. |
